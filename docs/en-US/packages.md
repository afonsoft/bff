...
- Swashbuckle.AspNetCore.Newtonsoft 10.2.3
- Project references: Core, Proxy

## src/Eaf.Template.Bff.Core
...
- OpenTelemetry.Instrumentation.Hangfire 1.17.0-beta.1
...
- Project reference: Proxy

## src/Eaf.Template.Bff.Proxy

- Newtonsoft.Json 13.0.4
- FluentValidation 12.1.1

## tests/Eaf.Template.Bff.Tests
...
- Project references: Core, Proxy, Host
