...
namespace Eaf.Template.Bff.Host.Controllers
{
    ...
    public class BaseController : ControllerBase
    {
        ...
        /// <summary>
        /// Create a <see cref="ServiceParamsOverride"/> from <see cref="DcpHeaders"/>
        /// </summary>
        /// <param name="headersDcpParams"><see cref="DcpHeaders"/></param>
        /// <returns><see cref="ServiceParamsOverride"/></returns>
